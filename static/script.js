...
const showcaseCases = [
    {
        ...
        prompt: "创建一张 1/7 比例的商业化人偶，以写实风格，放置在真实环境中。人偶放置在电脑桌上。人偶有一个圆形透明亚克力底座，底座上没有文字。电脑屏幕上显示的是这个人偶的 Zbrush 建模过程。电脑屏幕旁边是一个印有原作艺术品的 BANDAI 风格玩具包装盒。包装盒上印有二维平面插图。保持与图片的一致性。",
        author: "@ZHO_ZHO_ZHO",
        imageRequired: true,
